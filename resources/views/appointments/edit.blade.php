    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('salon.appointments.update', $appointment) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="time" class="form-control @error('appointment_time') is-invalid @enderror" 
                                               ...
                                               value="{{ old('appointment_time', $appointment->appointment_date ? $appointment->appointment_date->format('H:i') : '') }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('assigned_to') is-invalid @enderror" id="assigned_to" name="assigned_to">
                                            ...
                                            @foreach($employees as $employee)
                                                <option value="{{ $employee->id }}" {{ old('assigned_to', $appointment->employee_id) == $employee->id ? 'selected' : '' }}>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div id="selected-service" class="text-muted">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="service-duration" class="text-muted">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="service-price" class="fw-bold text-success">
                                                {{ $appointment->service ? '$' . number_format($appointment->service->price, 2) : '$0.00' }}
                                            </div>
                                        </div>
                                        
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Date & Time</label>
                                            <div id="appointment-datetime" class="text-muted">
